...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'filepilot.app',
        'filepilot.auto_start',
        'filepilot.cli',
        'filepilot.i18n',
        'filepilot.log',
        'filepilot.core.embeddings',
        ...
        'filepilot.core.task_scheduler',
        'filepilot.core.config',
        'filepilot.core.tag_manager',
        'filepilot.core.tag_rules',
        'filepilot.core.plugin_system',
        'filepilot.core.service_container',
        'filepilot.core.app_state',
        ...
        'filepilot.extractors.ocr_extractor',
        ...
        'filepilot.ui.tray',
        'filepilot.ui.tags_panel',
        'filepilot.ui.plugin_manager_panel',
        'filepilot.ui.dashboard_panel',
        'filepilot.ui.notification',
        'filepilot.ui.preview_panel',
        'filepilot.ui.directory_tree',
