...
class SummaryPanel(BasePanel):
    ...
    def _create_file_selection_area(self, layout):
        ...
        self.btn_add_folder = QPushButton(t("summary_add_folder"))
        self.btn_add_folder.clicked.connect(self._on_add_folder)
        self.btn_clear_files = QPushButton(t("summary_clear"))
        ...
        self.btn_cancel = QPushButton(t("summary_cancel"))
    ...
    def _create_results_splitter(self, layout):
        ...
        summary_layout.addWidget(QLabel(t("summary_section")))
        ...
        keyword_layout.addWidget(QLabel(t("summary_keywords")))
